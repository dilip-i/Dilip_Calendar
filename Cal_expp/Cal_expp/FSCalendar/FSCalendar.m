...
#import "FSCalendarWCollectionViewLayout.h"
...
@property (weak  , nonatomic) FSCalendarWCollectionViewLayout *wCollectionViewLayout;
@property (weak  , nonatomic) FSCalendarWCollectionView   *wCollectionView;
...
{   
    ...
    [collectionView registerNib:[UINib nibWithNibName:@"CustomCell" bundle:nil] forCellWithReuseIdentifier:FSCalendarDefaultCellReuseIdentifier];
//    [collectionView registerClass:[FSCalendarCell class] forCellWithReuseIdentifier:FSCalendarDefaultCellReuseIdentifier];
    ...
    //Define week no collection view
    
    // collection view
//    UICollectionViewFlowLayout *wCollectionViewLayout = [[UICollectionViewFlowLayout alloc] init];
//    [wCollectionViewLayout setItemSize:CGSizeMake(45, 45)];
//    [wCollectionViewLayout setMinimumLineSpacing:1];
//    [wCollectionViewLayout setMinimumInteritemSpacing:1];
//    [wCollectionViewLayout setSectionInset:UIEdgeInsetsMake(0, 0, 0, 0)];
//    [wCollectionViewLayout setScrollDirection:UICollectionViewScrollDirectionVertical];
    
    FSCalendarWCollectionViewLayout *wCollectionViewLayout = [[FSCalendarWCollectionViewLayout alloc] init];
    wCollectionViewLayout.calendar = self;
    
    FSCalendarWCollectionView *wCollectionView = [[FSCalendarWCollectionView alloc] initWithFrame:CGRectZero collectionViewLayout:wCollectionViewLayout];
    wCollectionView.dataSource = self;
    wCollectionView.delegate = self;
    wCollectionView.backgroundColor = [UIColor clearColor];
    wCollectionView.pagingEnabled = NO;
    wCollectionView.showsHorizontalScrollIndicator = NO;
    wCollectionView.showsVerticalScrollIndicator = NO;
    wCollectionView.allowsMultipleSelection = NO;
    wCollectionView.scrollEnabled = NO;
    wCollectionView.clipsToBounds = YES;
    [wCollectionView registerNib:[UINib nibWithNibName:@"WeekCell" bundle:nil] forCellWithReuseIdentifier:FSCalendarWeekNoCellReuseIdentifier];
//    [wCollectionView registerClass:[FSCalendarCell class] forCellWithReuseIdentifier:@"weekNo"];
    [wCollectionView registerClass:[FSCalendarBlankCell class] forCellWithReuseIdentifier:FSCalendarBlankCellReuseIdentifier];
    [daysContainer addSubview:wCollectionView];
    self.wCollectionView = wCollectionView;
    self.wCollectionViewLayout = wCollectionViewLayout;
        ...
        if (!self.floatingMode) {
            switch (self.transitionCoordinator.representingScope) {
                case FSCalendarScopeMonth: {
                    ...
                    _collectionView.frame = CGRectMake(_daysContainer.fs_width/8, 0, _daysContainer.fs_width - _daysContainer.fs_width/8, contentHeight);
                    _wCollectionView.frame = CGRectMake(0, 0, _daysContainer.fs_width/8, contentHeight);
...
//            _collectionView.frame = _daysContainer.bounds;
        ...
        _calendarWeekdayView.frame = CGRectMake(0, self.calendarHeaderView.fs_bottom, self.contentView.fs_width, weekdayHeight);
    }
...
- (void)prepareForInterfaceBuilder
{
    ...
    NSDateComponents *components = [self.gregorian components:NSCalendarUnitYear|NSCalendarUnitMonth|NSCalendarUnitDay|NSCalendarUnitWeekOfYear fromDate:date];
