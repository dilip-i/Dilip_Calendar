...
#import "FSCalendarWCollectionView.h"

@interface FSCalendar (Dynamic)

@property (readonly, nonatomic) FSCalendarCollectionView *collectionView;
@property (readonly, nonatomic) FSCalendarWCollectionView *wCollectionView;
...
@property (readonly, nonatomic) FSCalendarWCollectionViewLayout *wCollectionViewLayout;
...
@interface FSCalendarWCollectionViewLayout (Dynamic)
